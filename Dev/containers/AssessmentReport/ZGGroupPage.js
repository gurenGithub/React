...
class ZGGroupPage extends Component {
	...
	onFetch(searchItems,page,pageSize,onSuccess){
      ...
      var reports=[
         {title:'项目经理',href:'List/GetRPEstimateManagerReport/暂估阶段报表-项目经理'},
         {title:'项目',href:'List/GetRPRPEstimateProjectReport/暂估阶段报表-项目'},
         ]
